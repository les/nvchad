...
map("n", "gx", "<Cmd>silent !xdg-open <cWORD><CR>", { desc = "general open link under cursor" })
...
map("n", "<Leader>cc", "<Cmd>CopilotChatToggle<CR>", { desc = "copilot toggle chat window" })
...
map("n", "J", "mzJ`z") -- maintain cursor position when joining lines
...
--map({"n", "v"}, "<Leader>d", [[_d]], { desc = "registers delete to black hole register"})
